...
insert into bicycle (query_name, value) values ('bike_separate_path', (select sum(st_length(way))/1000 from planet_osm_line where (highway = 'cycleway' and osm_id > 0) or (highway = 'cycleway' and tags @> '"cycleway"=>"track"' and osm_id > 0)));
