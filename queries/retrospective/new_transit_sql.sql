...
--Length of new or modified route relations since the post

--Calculate the length of new or modified light rail, subway, train, and tram route relations since the post

insert into transit (query_name, value) values ('route_light_rail_rel_km_new', (select sum(st_length(way))/1000 from planet_osm_line where route = 'light_rail' and osm_id < 0 and osm_timestamp > '2016-03-18 14:00:00-07'));

insert into transit (query_name, value) values ('route_subway_rel_km_new', (select sum(st_length(way))/1000 from planet_osm_line where route = 'subway' and osm_id < 0 and osm_timestamp > '2016-03-18 14:00:00-07'));

insert into transit (query_name, value) values ('route_train_rel_km_new', (select sum(st_length(way))/1000 from planet_osm_line where route = 'train' and osm_id < 0 and osm_timestamp > '2016-03-18 14:00:00-07'));

insert into transit (query_name, value) values ('route_tram_rel_km_new', (select sum(st_length(way))/1000 from planet_osm_line where route = 'tram' and osm_id < 0 and osm_timestamp > '2016-03-18 14:00:00-07'));

--% of new or modified route relations with colour since the post

--Calculate the length of new or modified light rail, subway, train, and tram route relations with colour since the post

insert into transit (query_name, value) values ('route_light_rail_color_rel_km_new', (select sum(st_length(way))/1000 from planet_osm_line where route = 'light_rail' and (tags ?| array ['color', 'colour', 'gtfs_route_color', 'gtfs_route_colour']) and osm_id < 0 and osm_timestamp > '2016-03-18 14:00:00-07'));

insert into transit (query_name, value) values ('route_subway_color_rel_km_new', (select sum(st_length(way))/1000 from planet_osm_line where route = 'subway' and (tags ?| array ['color', 'colour', 'gtfs_route_color', 'gtfs_route_colour']) and osm_id < 0 and osm_timestamp > '2016-03-18 14:00:00-07'));

insert into transit (query_name, value) values ('route_train_color_rel_km_new', (select sum(st_length(way))/1000 from planet_osm_line where route = 'train' and (tags ?| array ['color', 'colour', 'gtfs_route_color', 'gtfs_route_colour']) and osm_id < 0 and osm_timestamp > '2016-03-18 14:00:00-07'));

insert into transit (query_name, value) values ('route_tram_color_rel_km_new', (select sum(st_length(way))/1000 from planet_osm_line where route = 'tram' and (tags ?| array ['color', 'colour', 'gtfs_route_color', 'gtfs_route_colour']) and osm_id < 0 and osm_timestamp > '2016-03-18 14:00:00-07'));

--% of new or modified route relations with colour since the post

--Calculate the % of new or modified light rail, subway, train, or tram route relations with colour since the post

insert into transit (query_name, value) values ('route_light_rail_color_rel_km_pct_new', (((select value from transit where query_name = 'route_light_rail_color_rel_km_new')/(select value from transit where query_name = 'route_light_rail_rel_km_new')) *100));

insert into transit (query_name, value) values ('route_subway_color_rel_km_pct_new', (((select value from transit where query_name = 'route_subway_color_rel_km_new')/(select value from transit where query_name = 'route_subway_rel_km_new')) *100));
